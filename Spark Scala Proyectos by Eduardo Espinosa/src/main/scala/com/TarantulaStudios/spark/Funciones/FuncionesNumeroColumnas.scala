...
object FuncionesNumeroColumnas extends App {

  val spark: SparkSession = SparkSession.builder()
    .master("local[*]")
    .appName("Numero de Columnas Función")
    .getOrCreate()
  ...
  val numerocolumnas = Window.partitionBy("Fabricante").orderBy("Precio")
  df.withColumn("row_number", row_number.over(numerocolumnas))
    .show()
}
