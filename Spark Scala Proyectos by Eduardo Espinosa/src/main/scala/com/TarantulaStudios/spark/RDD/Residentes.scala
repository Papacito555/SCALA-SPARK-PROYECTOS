...
object Residentes {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val residentes = spark.read
      ...
      .csv("C:/Users/SDS-Usuario/Downloads/spark/data/data/COVID HCM.csv")
    ...
    todos.repartition(1).write
      ...
      .json("C:/Users/SDS-Usuario/Downloads/spark/data/data/Datos_Covid12")
    ...
    repetidos.sort($"Nombre").repartition(1).write
      .option("Header", "True")
      .mode(SaveMode.Overwrite)
      .json("C:/Users/SDS-Usuario/Downloads/spark/data/data/Datos_Covid12/Repetidos")
